def twitter_analysis(uri,mydb):
	...
	prev_week = pd.to_datetime(datetime.date(year, 1, 1) + relativedelta(weeks=week-2))
	...
	def transform(df_dumped, key_words):
		...
		df_dumped=df_dumped[df_dumped['createdAt']>=prev_week]
		...
		return df_tweet_count, df_daily_tweet_count, df_tweet_dist,df_daily_tweetdist_retweet,df_daily_tweetdist_replies, df_daily_tweetdist_direct_tweets,top_df, df_nps, df_reach, df_popular, df_more_retweet, df_entity,df_positive_profile, df_negative_profile
	...
	df_tweet_count, df_daily_tweet_count, df_tweet_dist,df_daily_tweetdist_retweet,df_daily_tweetdist_replies, df_daily_tweetdist_direct_tweets,top_df, df_nps, df_reach, df_popular, df_more_retweet, df_entity,df_positive_profile, df_negative_profile= transform(df_dumped, key_words)
	#pushdata(df_tweet_count, df_tweet_dist, top_df, df_nps, df_reach, df_popular, df_more_retweet, df_entity)

	return df_tweet_count, df_daily_tweet_count, df_tweet_dist,df_daily_tweetdist_retweet,df_daily_tweetdist_replies, df_daily_tweetdist_direct_tweets,top_df, df_nps, df_reach, df_popular, df_more_retweet, df_entity,df_positive_profile, df_negative_profile
df_tweet_count, df_daily_tweet_count, df_tweet_dist,df_daily_tweetdist_retweet,df_daily_tweetdist_replies, df_daily_tweetdist_direct_tweets,top_df, df_nps, df_reach, df_popular, df_more_retweet, df_entity,df_positive_profile, df_negative_profile = twitter_analysis(uri,mydb)