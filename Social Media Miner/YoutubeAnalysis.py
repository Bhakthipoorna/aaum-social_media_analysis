def YoutubeAnalysis(uri,mydb,tag):
	...
	def transform(df):
		...
		#df=df[df['updated_at']>='2022-08-27']
	...
	return df_views,df_likes,df_comments,df_reach, df_views_overtime,df_likes_overtime,df_comments_overtime,top_df,df_nps, df_positive_negative, df_positive_profile, df_negative_profile, df_entity
df_views, df_likes, df_comments, df_reach, df_views_overtime, df_likes_overtime, df_comments_overtime, top_df, df_nps, df_positive_negative, df_positive_profile, df_negative_profile, df_entity = YoutubeAnalysis(uri,mydb,tag)