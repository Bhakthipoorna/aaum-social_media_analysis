...
def twitter_analysis(uri,mydb,tag):
	...
	def transform(df_dumped, key_words):
		...
		return df_daily_tweet_count, df_daily_tweetdist_retweet,df_daily_tweetdist_replies, df_daily_tweetdist_direct_tweets, df_nps, df_reach, df_entity

	def pushdata(df_daily_tweet_count, df_daily_tweetdist_retweet,df_daily_tweetdist_replies, df_daily_tweetdist_direct_tweets, df_nps, df_reach, df_entity):
	...
	df_daily_tweet_count, df_daily_tweetdist_retweet,df_daily_tweetdist_replies, df_daily_tweetdist_direct_tweets, df_nps, df_reach, df_entity = transform(df_dumped, key_words)
	#pushdata(df_daily_tweet_count, df_daily_tweetdist_retweet,df_daily_tweetdist_replies, df_daily_tweetdist_direct_tweets, df_nps, df_reach, df_entity)
