import sys
def twitter_analysis_daily(uri,mydb,tag):
	...
	def transform(df_dumped, key_words):
		...
		df=df[df['text'].str.contains(key_words, na=False)]
		...
		if len(df)<1:
			...
			df_sentiment=pd.DataFrame(['nps','positive','negative'])
			df_sentiment.columns=['metric']
	...
	def pushdata(df_daily_tweet_count, df_daily_tweetdist_retweet,df_daily_tweetdist_replies, df_daily_tweetdist_direct_tweets, df_nps, df_sentiment, df_reach, df_entity):
	...
	df_daily_tweet_count, df_daily_tweetdist,df_daily_tweetdist_retweet,df_daily_tweetdist_replies, df_daily_tweetdist_direct_tweets, df_nps, df_sentiment, df_reach, df_entity = transform(df_dumped, key_words)
	pushdata(df_daily_tweet_count, df_daily_tweetdist_retweet,df_daily_tweetdist_replies, df_daily_tweetdist_direct_tweets, df_nps, df_sentiment, df_reach, df_entity)
